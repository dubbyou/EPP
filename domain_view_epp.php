       			...
       			<div id="rightnow">
					...
					if ($myEppDomain->ID ==""){
						...
						print "<p class=\"error\">Unable to run a check as the Domain is blank</p>";
											...
											?>
                                            					<table class="simple">
                                                                  <tr><td width="100px">Domain Name : </td><td width="250px"><?php print $newdoc->getElementsByTagName('name')->item(0)->nodeValue; ?></td><td></td></tr>
                                                                   <tr><td>Status : </td><td width="250px"><?php print $newdoc->getElementsByTagName('status')->item(0)->nodeValue; ?></td><td> - <?php print $newdoc->getElementsByTagName('status')->item(0)->getAttribute('s'); ?></td></tr>
                                                                    <tr><td>Registrant ID: </td><td><?php print $newdoc->getElementsByTagName('registrant')->item(0)->nodeValue; ?></td><td></td></tr>
                                            
                                                                    <tr><td><br /></td></tr>
                                                                    <tr><td>Created : </td><td><?php print $newdoc->getElementsByTagName('crDate')->item(0)->nodeValue; ?></td><td></td></tr>
                                                                    <tr><td>Updated : </td><td><?php print $newdoc->getElementsByTagName('upDate')->item(0)->nodeValue; ?></td><td></td></tr>
                                                                    <tr><td>Expires : </td><td><?php print $newdoc->getElementsByTagName('exDate')->item(0)->nodeValue; ?></td><td></td></tr>
                                                                    ...
                                                                    <tr><td>AutoRenew : </td><td><?php print $newdoc->getElementsByTagName('autorenew')->item(0)->nodeValue; ?></td><td></td></tr>
