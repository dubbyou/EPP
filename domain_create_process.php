            ...
            <div id="content">
					...
					if ($DomainName == "" ||$ContactID == ""){
						...
						print "<p lass=\"error\">Unable to register the contact as data is missing</p>";
											...
											$NameServers=array();
											if ($NameServer1 != ""){
												array_push($NameServers, $NameServer1);
											}
											if ($NameServer2 != ""){
												array_push($NameServers, $NameServer2);
											}
											if ($NameServer3 != ""){
												array_push($NameServers, $NameServer3);
											}
											if ($NameServer4 != ""){
												array_push($NameServers, $NameServer4);
											}											
											
											
											
											$myEppDomain = new EppDomain();
											$resultcode = $myEppDomain->Create($DomainName,$ContactID,$NameServers,"coza");
