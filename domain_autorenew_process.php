					...
					if ($myEppDomain->ID == ""){
						...
						print "<p>Unable to run a check as the domain is blank</p>";
											...
											if ($myEppDomain->IsAutoRenew == 0){
														...
														$resultcode = $myEppDomain->AutoRenewOn();
														if ($resultcode == 1000){
														print "<p class=\"warning\">Turned AutoRenew on</p>";
														}
											}else{
													    $resultcode = $myEppDomain->AutoRenewOff();
														if ($resultcode == 1000){
														print "<p class=\"warning\">Turned AutoRenew off</p>";
														}
											}
...
<table class="simple">
                                        ...
                                        <tr><td>Registrant ID: </td><td><?php print "<a href=\"registrant_view.php?ContactId=\">".$myEppDomain->ContactID."</a>"; ?></td><td></td></tr>
                                        <tr><td>Registrant Name: </td><td><?php print $myEppContact->EppContactName; ?></td><td></td></tr>
