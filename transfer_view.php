                   ...
                   <div id="rightnow">
                	<h3 class="reallynow">
                     ...
                     <br />
																			...
																			<table class="simple">
																				<tr><td width="100px">Domain Name : </td><td width="250px"><?php print "$myEppTransfer->Name"; ?></td><td></td></tr>
                                                                                <tr><td width="100px">Status : </td><td width="250px"><?php print "$myEppTransfer->Status"; ?></td><td></td></tr>
