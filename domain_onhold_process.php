       			...
       			<div id="rightnow">
					...
					if ($myEppDomain->ID == ""){
						...
						print "<p>Unable to run a check as the domain is blank</p>";
											...
											if ($myEppDomain->IsOnHold == 0){
														
														$resultcode = $myEppDomain->TurnOnHoldOn();
														if ($resultcode == 1000){
														print "<p class=\"warning\">Turned on hold on</p>";
														}
											}else{
													    $resultcode = $myEppDomain->TurnOnHoldOff();
														if ($resultcode == 1000){
														print "<p class=\"warning\">Turned on hold off</p>";
														}
											}
