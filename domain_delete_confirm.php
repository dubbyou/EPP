            ...
            <div id="content">
       			<div id="rightnow">
                    <h3 class="reallynow">
                        ...
                        <a class="userdelete" href="domain_delete_process.php?ID=<?php print "$myEppDomain->ID"; ?>">Procced and Delete</a>
                        <br />
                    </h3>
						...
						<?php
							...
							if ($myEppDomain->ID == ""){
								...
								print "<p class=\"warning\">You are about to delete a Domain. Are you sure you would like to continue? All host will be deleted</p>";
